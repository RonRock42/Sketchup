(function() {
  ...
  $rs(document).ready(function($rs) {
    ...
    if (!mySlider.status.playing) {
      $rs("#cc-slideshow-32b15f01 .icon-pause").attr("class", "icon-play-3");
    }

    $rs("#cc-slideshow-32b15f01 .pause, #cc-slideshow-32b15f01 .play").click(function(e) {
      var $icon;
      e.preventDefault();
      $icon = $rs(this).find('i');
    ...
    $rs('#cc-slideshow-32b15f01 [class*="coffee-slider-"]').click(function(e) {
      var command;
      e.preventDefault();
    ...
    mySlider.on("transitionComplete", function() {
      var slides_indicator = $rs('#cc-slideshow-32b15f01 .slides_indicator')
        , index =$rs('#cc-slideshow-32b15f01 .slide.' + app.configSlideshow().active_slide_class).index();
    ...
    $rs("a").click(function(e) {
      var id = this.href.match(/#(?:(?!\?).)*/g)
        , index;
      if ($rs(this).is('#cc-slideshow-32b15f01 .slide_node')) { return goToFromIndicator(e); }
    ...
    swipedetect($rs("#cc-slideshow-32b15f01 .slides_container")[0], function(direction) {
      switch(direction) {
        case "right":
